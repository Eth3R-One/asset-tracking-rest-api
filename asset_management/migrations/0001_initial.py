    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checked_out_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset_management.employee')),
        ...
        migrations.AddField(
            model_name='device',
            name='checked_out_to',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset_management.employee'),
        ),
        migrations.AddField(
            model_name='device',
            name='company',
